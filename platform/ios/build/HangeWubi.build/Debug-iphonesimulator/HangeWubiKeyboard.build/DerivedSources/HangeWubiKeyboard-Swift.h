...
#ifndef HANGEWUBIKEYBOARD_SWIFT_H
#define HANGEWUBIKEYBOARD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HangeWubiKeyboard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC17HangeWubiKeyboard16CandidateBarView")
@interface CandidateBarView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC17HangeWubiKeyboard12KeyboardView")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC17HangeWubiKeyboard22KeyboardViewController")
