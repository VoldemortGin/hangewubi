...
#ifndef HANGEWUBI_SWIFT_H
#define HANGEWUBI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HangeWubi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIWindow;
@class UIApplication;
SWIFT_CLASS("_TtC9HangeWubi11AppDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC9HangeWubi18MainViewController")
